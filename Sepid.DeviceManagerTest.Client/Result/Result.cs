...
namespace Sepid.DeviceManagerTest.Client.Result
{
    public class Result<T>
    {
        ...
        public static Result<T> Failed(string message, string reason = "", int statusCode = 400) => new Result<T> { Success = false, Reason = reason, Message = message, StatusCode = statusCode };
    }
