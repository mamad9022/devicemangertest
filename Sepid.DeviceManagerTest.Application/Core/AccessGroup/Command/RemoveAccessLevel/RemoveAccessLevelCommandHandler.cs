...
{
    public class RemoveAccessLevelCommandHandler : IRequestHandler<RemoveAccessLevelCommand, Result>
    {
        private readonly IDeviceManagerContext _context;
        private readonly ILocalization _localization;

        public RemoveAccessLevelCommandHandler(IDeviceManagerContext context, ILocalization localization)
        {
            _context = context;
            _localization = localization;
        }

        public async Task<Result> Handle(RemoveAccessLevelCommand request, CancellationToken cancellationToken)
        {
            #region Find Device
            ...
            var result = context.RemoveAccessLevel(new BaseDeviceInfoDto
            {
                Ip = device.Ip,
