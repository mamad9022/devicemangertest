...
{
    public class RebootDeviceCommandHandler : IRequestHandler<RebootDeviceCommand, Result>
    {
        private readonly IDeviceManagerContext _context;
        private readonly ILocalization _localization;

        public RebootDeviceCommandHandler(IDeviceManagerContext context, ILocalization localization)
        {
            _context = context;
            _localization = localization;
        }

        public async Task<Result> Handle(RebootDeviceCommand request, CancellationToken cancellationToken)
        {
            #region Find Device
            ...
            var result = context.RebootDevice(new BaseDeviceInfoDto
            {
                Ip = device.Ip,
                Port = device.Port,
