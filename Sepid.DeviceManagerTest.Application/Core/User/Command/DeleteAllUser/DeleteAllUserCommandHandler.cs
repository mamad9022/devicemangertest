...
{
    public class DeleteAllUserCommandHandler : IRequestHandler<DeleteAllUserCommand, Result>
    {
        private readonly IDeviceManagerContext _context;
        private readonly ILocalization _localization;

        public DeleteAllUserCommandHandler(IDeviceManagerContext context, ILocalization localization)
        {
            _context = context;
            _localization = localization;
        }

        public async Task<Result> Handle(DeleteAllUserCommand request, CancellationToken cancellationToken)
        {
            #region Find Device
            ...
            var result = context.DeleteAllUser(new BaseDeviceInfoDto
            {
