...
{
    public class SetTimeCommandValidator : AbstractValidator<SetTimeOperationCommand>
    {
        private readonly IDeviceManagerContext _context;
        private readonly ILocalization _localization;
        public SetTimeCommandValidator(IDeviceManagerContext context, ILocalization localization)
        {
            _context = context;
            ...
            RuleFor(dto => dto.Date).NotEmpty().WithMessage(_localization.GetMessage(ResponseMessage.DateIsRequired)).NotNull().WithMessage(_localization.GetMessage(ResponseMessage.DateIsRequired));
